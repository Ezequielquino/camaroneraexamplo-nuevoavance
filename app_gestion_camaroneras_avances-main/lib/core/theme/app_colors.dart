...
class AppColors {
  ...
  static const Color kBase = Color.fromRGBO(0, 113, 206, 1.0);
  static const Color kPrimary = Color.fromRGBO(47, 46, 65, 1.0);
  static const Color kSecondary = Color.fromRGBO(147, 147, 178, 1.0);
  //Color.fromRGBO(250, 252, 253, 1.0);
  static const Color kFillColor = Color.fromRGBO(242, 248, 251, 1.0);
  static const Color kDividerLine = Color.fromRGBO(230, 230, 241, 1.0);
